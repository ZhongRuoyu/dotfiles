...
- Add explanatory comments when the code or its motivation is not trivial.
  Public-facing functions should have doc comments explaining their purpose and
  behavior.
...
- Never use tabs, except in Makefiles and for languages where tabs are the
  standard indentation method (e.g., Go).
- Files should always end with a single newline character.
...
- The commit message should have a concise title and descriptive body.
  In the body, explain the motivation for the change and contrast with previous
  behavior.
